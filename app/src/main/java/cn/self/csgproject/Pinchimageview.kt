...
//            //控件大小
//            val tempDst =
//                MathUtils.rectFTake(0f, 0f, width.toFloat(), height.toFloat())
//            //计算fit center矩阵
...
//     * @see .getMaxScale
//     */
//    protected fun calculateNextScale(
//        innerScale: Float,
//        outerScale: Float
//    ): Float {
...
//                val tempDst =
//                    rectFTake(0f, 0f, container.width(), container.height())
//                matrix.setRectToRect(tempSrc, tempDst, Matrix.ScaleToFit.CENTER)
//                matrix.mapRect(result, rect)
//                rectFGiven(tempDst)
//                rectFGiven(tempSrc)
...
//         * 图片最大放大比例
//         */
//        protected const val maxScale = 4f
//        ////////////////////////////////公共状态获取////////////////////////////////
//        /**
//         * 手势状态：自由状态
//         *
